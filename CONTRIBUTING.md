...
```console
$ git clone git@github.com:bitExpert/sylius-product-document-plugin.git
$ cd sylius-product-document-plugin
```
...
2. Fork the repository (http://github.com/bitExpert/sylius-product-document-plugin)
...
```console
$ git remote add {username} git@github.com:{username}/sylius-product-document-plugin.git
$ git fetch {username}
```

### Keeping Up-to-Date

Periodically, you should update your fork or personal repository to match the canonical sylius-product-document-plugin repository.
...
To ssh://git@github.com/{username}/sylius-product-document-plugin.git
